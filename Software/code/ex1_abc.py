...
def run():
    ...
    for i in range(len(sample_sizes)):
        ...
        dir_ms = "../data/real/hiv/abc/" + str(names[i]) + "/ms/"
        dir_cv = "../data/real/hiv/abc/" + str(names[i]) + "/cv/"
    ...
    stat_path = "../results/real/hiv/abc/stat_abc_20_50_150.npz"
    ...
    ylim = (0, 50)
    xlabel, ylabel, fname = "Sample size", "CI length", "../results/real/hiv/abc/figures/cpl_abc_20_50_150.pdf"
    util_interactions.plot(data_mlp, data_rf, data_lf, data_ls, data_sf, data_ss, sample_sizes, xlabel, ylabel, fname, ylim)

    ylim = (-2, +2)
    xlabel, ylabel, fname = "Sample size", "r2 score", "../results/real/hiv/abc/figures/r2_abc_20_50_150.pdf"
