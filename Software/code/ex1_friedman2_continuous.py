...
def run(data_path="../data/friedman2_continuous/"):
    ...
    stat_path = "../results/friedman2_continuous/stat_friedman2_continuous_50_100_200.npz"
    ...
    xlabel, ylabel, fname = "Sample size", "CI length", "../results/friedman2_continuous/figures" \
                                                        "/cpl_friedman2_continuous_50_100_200.pdf"
    util_interactions.plot(data_mlp, data_rf, data_lf, data_ls, data_sf, data_ss, sample_sizes, xlabel, ylabel, fname,
                           ylim)

    ylim = (-2.5, +2.2)
    xlabel, ylabel, fname = "Sample size", "r2 score", "../results/friedman2_continuous/figures" \
                                                       "/r2_friedman2_continuous_50_100_200.pdf"
    util_interactions.plot(r2_mlps, r2_rfs, r2_lfs, r2_lss, r2_sfs, r2_sss, sample_sizes, xlabel, ylabel, fname, ylim)


def friedman_continuous():
